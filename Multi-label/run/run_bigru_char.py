...
from nlp.models.bigru import TextClassifier, TextClassifier2
from keras.utils.vis_utils import plot_model
from helper import logging, logging_csv

# conf-my
myconf = Config("conf/bigru_char.conf")
...
if __name__ == "__main__":
    if len(sys.argv) != 2 or sys.argv[1] not in ["-train", "-pred"]:
        raise ValueError("""usage: python run_bigru_char.py [-train / -pred]""")
