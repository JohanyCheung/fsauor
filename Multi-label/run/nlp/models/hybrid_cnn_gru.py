...
class TextClassifier():
    ...
    def model(self, maxlen, num_class, word_index, emb_w2v, emb_glove, emb_pinyin):
        ...
        x_conv_3 = Conv1D(64, kernel_size=3, strides=1, padding="valid", kernel_initializer="he_uniform")(x)
        x_conv_5 = Conv1D(64, kernel_size=5, strides=1, padding="valid", kernel_initializer="he_uniform")(x)
        x_conv_7 = Conv1D(64, kernel_size=7, strides=1, padding="valid", kernel_initializer="he_uniform")(x)

        # x_conv3_ap = GlobalAveragePooling1D()(x_conv_3)
        # x_conv3_mp = GlobalMaxPooling1D()(x_conv_3)
        # x_conv_3 = Concatenate()([x_conv3_ap, x_conv3_mp])
        # x_conv5_ap = GlobalAveragePooling1D()(x_conv_5)
        # x_conv5_mp = GlobalMaxPooling1D()(x_conv_5)
        # x_conv_5 = Concatenate()([x_conv3_ap, x_conv5_mp])
        # x_conv7_ap = GlobalAveragePooling1D()(x_conv_7)
        # x_conv7_mp = GlobalMaxPooling1D()(x_conv_7)
        # x_conv_7 = Concatenate()([x_conv3_ap, x_conv7_mp])

        x_conv = Concatenate()([x_conv_3, x_conv_5, x_conv_7])
        ...
        x_remb_attention = Attention(maxlen)(x_conv)
