...
class TextClassifier():
    ...
    def model(self, maxlen, num_class, word_index, emb_w2v, emb_glove, emb_pinyin):
        ...
        x_1 = SpatialDropout1D(0.2)(x_emb)
        x_2 = Bidirectional(CuDNNGRU(128, return_sequences=True))(x_1)

        capsule_1 = Capsule(num_capsule=10, dim_capsule=16, routings=5,
                          share_weights=True)(x_2)
        capsule_2 = Capsule(num_capsule=10, dim_capsule=17, routings=5,
                          share_weights=True)(x_2)
        capsule_1 = Flatten()(capsule_1)
        capsule_2 = Flatten()(capsule_2)
        capsule = Concatenate()([capsule_1, capsule_2])

        x_3 = Dense(256, activation=None)(capsule)
        x_4 = BatchNormalization()(x_3)
        x_5 = LeakyReLU()(x_4) # x_5 = Activation('relu')(x_4)
        x_6 = Dropout(0.2)(x_5)
