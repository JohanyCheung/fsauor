...
if __name__ == "__main__":
    ...
    model, callbacks_list=build_resnet(max_num_word=7400,max_len_word=1500)
    model.fit(x_train, y_train, epochs=2, batch_size=64, validation_data=(x_val, y_val), callbacks=callbacks_list)
